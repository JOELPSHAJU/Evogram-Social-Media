  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: appbarTitle(title: 'Terms & Conditions'),
      ),
      body: const SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            h10,
            Text(
              'These terms and conditions applies to the interact app (hereby referred to as "Application") for mobile devices that was created by Joel P Shaju (hereby referred to as "Service Provider") as a Free service.',
              textAlign: TextAlign.justify,
              style: TextStyle(fontSize: 14, color: grey80),
            ),
            h10,
            Text(
